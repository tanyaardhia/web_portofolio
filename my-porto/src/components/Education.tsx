...
const Details = ({ type, place, info, time }: EducationProps) => {
    ...
    <div className="text-center my-32">
      ...
      <div ref={ref} className="w-full sm:w-[75%] mx-auto relative">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            type="Fullstack JavaScript Bootcamp"
            place="Hacktiv8"
            time="October 2023 - January 2024"
            info="Backend Developer & Frontend Developer"
          />
          <Details
            type="Bachelor of Marketing Management"
            place="Paramadina University"
            time="September 2016 - March 2020"
            info="Marketing Management"
          />
        </ul>
      </div>
    </div>
